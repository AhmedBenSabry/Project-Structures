...
| ترتيب | الجدول                        | الوصف                                    | ملاحظات مهمة                          |
|------|-------------------------------|------------------------------------------|---------------------------------------|
| 1    | **Company**                   | الشركة (الـ Tenant الرئيسي)             | أول جدول يتملي خالص                   |
| 2    | **SubscriptionPlan**          | خطط الاشتراك                             |                                        |
| 3    | **CompanySubscriptions**      | تاريخ بدء وانتهاء اشتراك الشركة          |                                        |
| 4    | **Currency**                  | العملات                                  |                                        |
| 5    | **Country → City → Zone**     | الدول والمدن والمناطق                     | لازم بالترتيب ده                       |
| 6    | **AspNetUsers**               | مستخدمي النظام (Identity)                | أساس كل User في النظام                |
| 7    | **AspNetRoles / AspNetUserRoles** | الأدوار والصلاحيات                         |                                        |
| 8    | **Employee**                  | بيانات الموظف الرئيسية (Id = AspNetUsers.Id)| أخطر وأهم جدول بعد Company           |
| 9    | **Branch**                    | الفروع                                   |                                        |
| 10   | **Department**                | الأقسام                                  |                                        |
| 11   | **PositionType**              | أنواع المناصب                            |                                        |
| 12   | **Position**                  | المناصب (Hierarchical)                   | PositionManagerId → Position.Id       |
| 13   | **Teams**                     | الفرق                                    |                                        |
| 14   | **EmployeeLevel**             | مستويات الموظفين (Junior, Senior, …)    |                                        |
| 15   | **EmployeeLevelSetting**      | إعدادات المستوى (إجازات، بدلات…)         |                                        |
| 16   | **EmployeeLevelSettingAssignment** | Many-to-Many بين المستوى والإعدادات       |                                        |

### 2. جداول بيانات الموظف التفصيلية (Employee Details)
| ترتيب | الجدول                           | الوصف                                   | ملاحظات |
|------|----------------------------------|-----------------------------------------|---------|
| 17   | **UserAddress**                  | عناوين الموظف                            | FK → AspNetUsers.Id |
| 18   | **UserEmail**                    | إيميلات إضافية                          |         |
| 19   | **UserTelephone**                | أرقام تليفون إضافية                      |         |
| 20   | **UserAttachment**               | مرفقات شخصية (صورة بطاقة، CV…)          |         |
| 21   | **UserLifeStyle**                | أنماط الحياة (مدخن، رياضي…)             |         |
| 22   | **UserRefernce**                 | المراجع الشخصية                          |         |
| 23   | **EmployeeEducational**          | المؤهلات الدراسية                        |         |
| 24   | **EmployeeCertificate**          | الشهادات المهنية                         |         |
| 25   | **EmployeeWorkHistory**          | الخبرات السابقة                          |         |
| 26   | **EmployeeHealthInformation**    | الحالة الصحية (فصيلة الدم، أمراض…)       |         |
| 27   | **EmployeeIdentityDocument**     | وثائق الهوية                             |         |
| 28   | **EmployeeLanguage**             | اللغات                                   |         |
| 29   | **EmployeeSkills**               | المهارات                                 |         |

### 3. الحضور والانصراف (Attendance)
| ترتيب | الجدول                            | الوصف                                    |
|------|-----------------------------------|------------------------------------------|
| 30   | **AttendanceType**                | أنواع الحضور (دخول، خروج، إجازة…)        |
| 31   | **CompanyOffDays**                | عطلات الشركة الرسمية                      |
| 32   | **EmployeeAttendanceLocation**    | المواقع المسموحة لكل موظف                 |
| 33   | **EmployeeAttendance**            | سجلات الدخول والخروج                     |
| 34   | **EmployeeAttendanceMains**       | الملخص اليومي (WorkingHours محسوبة)       |

### 4. الطلبات (Requests)
| ترتيب | الجدول                      | الوصف                                      |
|------|-----------------------------|--------------------------------------------|
| 35   | **RequestCategory**         | تصنيفات الطلبات                            |
| 36   | **RequestType**             | أنواع الطلبات                              |
| 37   | **RequestStatus**           | حالات الطلب                                |
| 38   | **RequestTypeConfigs**      | إعدادات مصفوفة الموافقات لكل نوع طلب       |
| 39   | **Request**                 | الطلبات (إجازة، إذن، عهدة…)                |
| 40   | **RequestApprovalMatrix**   | مصفوفة الموافقات (من → إلى)                |
| 41   | **RequestAttachment**       | مرفقات الطلب                               |

### 5. الأصول (Assets)
| ترتيب | الجدول                | الوصف                                   |
|------|-----------------------|-----------------------------------------|
| 42   | **AssetCategory**     | تصنيفات الأصول (Hierarchical)           |
| 43   | **Assets**            | الأصول نفسها (ParentAssetId + EmployeeId)|
| 44   | **AssetAttachment**   | مرفقات الأصول                           |

### 6. المهام (Tasks)
| ترتيب | الجدول                 | الوصف                                   |
|------|------------------------|-----------------------------------------|
| 45   | **TaskPriority / TaskStatus** | الأولوية والحالة                     |
| 46   | **Tasks**              | المهام الرئيسية                         |
| 47   | **TaskAssignments**    | تعيين الموظفين للمهمة                    |
| 48   | **ToDoItems**          | البنود الفرعية                          |
| 49   | **TaskAttachments**    | مرفقات المهمة                           |
| 50   | **TaskDepartments**    | Many-to-Many بين Task و Department       |

### 7. المسارات والعملاء (Sales Routes)
| ترتيب | الجدول             | الوصف                                   |
|------|--------------------|-----------------------------------------|
| 51   | **Paths**          | المسارات التجارية                        |
| 52   | **Customers**      | العملاء (Self-Reference للجملة/تجزئة)   |
| 53   | **EmployeePaths**  | ربط الموظف بالمسار (Many-to-Many)        |
| 54   | **CustomerPath**   | ربط العميل بالمسار (Many-to-Many)        |

### 8. الماليات والمدفوعات
| ترتيب | الجدول                        | الوصف                                  |
|------|-------------------------------|----------------------------------------|
| 55   | **PaymentTypes**              | طرق الدفع                              |
| 56   | **Payables**                  | المستحقات (ديون العملاء)              |
| 57   | **Receivables**               | التحصيلات                              |
| 58   | **FinancialCustodies**        | العهد المالية                          |
| 59   | **BankTransfareFromEmployees**| تحويلات بنكية من الموظفين             |

### 9. الموردين
| ترتيب | الجدول           | الوصف                          |
|------|------------------|-------------------------------|
| 60   | **VendorTypes**  | أنواع الموردين                |
| 61   | **Vendors**      | الموردين                      |

### 10. الرواتب والمستحقات
| ترتيب | الجدول                        | الوصف                                  |
|------|-------------------------------|----------------------------------------|
| 62   | **EmployeeDeduction**         | الخصومات                               |
| 63   | **EmployeeEntitlment**        | المستحقات والبدلات                     |
| 64   | **MassiveActionTransactions** | العمليات الجماعية (خصم/إضافة لمجموعة) |
| 65   | **EmployeeSalaryArchives**    | أرشيف الرواتب الشهرية                 |

### 11. القضايا والشكاوى (Issues)
| ترتيب | الجدول                | الوصف                           |
|------|-----------------------|---------------------------------|
| 66   | **Issue**             | الشكاوى والقضايا                |
| 67   | **IssueExcuter**      | منفذي القضية                     |
| 68   | **IssueAttachment**   | مرفقات القضية                    |
| 69   | **IssueComment**      | التعليقات على القضية             |

### 12. الإشعارات والدعم
| ترتيب | الجدول                   | الوصف                           |
|------|--------------------------|---------------------------------|
| 70   | **NotificationLog**      | سجل الإشعارات                   |
| 71   | **Support / SupportAttachment** | طلبات الدعم               |
| 72   | **Help / HelpAttachment** | طلبات المساعدة                 |

### 13. الجداول المرجعية (Lookup Schema) – تملي مرة واحدة في حياة النظام
كل الجداول دي في schema اسمه **[Lookup]**:
- Country → City → Zone  
- Currency, BloodType, Degree, Grade, Language, DocumentType  
- BusinessType, BusinessSize, CertificateType, SkillsType  
- LifeStyleType, AttachmentCategory, FileDescriptionType  
- MedicalInsuranceCompany, OnBoarding, PersonalType, RefernceType  
- TaskPriority, TaskStatus, RequestStatus, IssueStatus, AssetStatus  
- DeductionType, EntitlmentType, AttendanceType, PaymentTypes, VendorTypes

### 14. جداول الهيكل التنظيمي الديناميكي
| ترتيب | الجدول               | الوصف                                   |
|------|----------------------|-----------------------------------------|
| 73   | **OrganizationChart**| الرسم التنظيمي الديناميكي (EntityId + Type + ParentId) |

### 15. جداول Identity الإضافية
| ترتيب | الجدول                  | الوصف                         |
|------|-------------------------|------------------------------|
| 74   | AspNetUserClaims        | Claims إضافية                 |
| 75   | AspNetUserLogins        | Social Login (Google/Facebook)|
| 76   | AspNetUserTokens        | Refresh Tokens               |

## ملاحظات مهمة جدًا
- كل جدول تقريبًا فيه: `CompanyId`, `IsDelete`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`
